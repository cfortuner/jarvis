...
class ChromiumAutomation(BrowserAutomation):
    """Controls Chromium derived browsers."""
    def __init__(self, desktop: DesktopAutomation, name: str):
    ...
    def _get_menu_items_for_all_tabs(self) -> list:
